...
$(document).ready(function () {
    ...
    //下拉重新加载
    ScrollReload.Listen("divCartList", "div_scrolldown", "Cart", "10", CartInfo.UploadDate_re);
    ScrollReload.Listen("divCartNull", "div_scrolldown", "Cart", "10", CartInfo.UploadDate_re);
});
...
var CartInfo = {
    ...
    LoadData: function () {
        ...
        //登录后，提交空，获取云端购物车内容，更新本地缓存
        if (UserLogin.LoginStatus == g_const_YesOrNo.YES) {

            if (CartInfo.isInit == 0) {
                objcarts = [];
            }
    ...
    SetCartList: function (msg) {
        ...
        if (msg.acount_num > 0) {
            ...
            $.each(msg.shoppingCartList, function (k, o) {
                ...
                if (o.event.tagname.length > 0) {
                    //divHtml += "<h2 onclick=\"CartInfo.OpenFullCut('" + o.event.forwardType + "','" + o.event.forwardVal + "','" + o.eventCode + "','" + o.start_time + "','" + o.end_time + "')\"><a><em>" + o.event.tagname + "</em><span class=\"content\">" + o.event.description + "</span>";
        ...
        setTimeout("$('#div_scrolldown').hide()", 1000);
        //setInterval("$(\"#div_scrolldown\").hide()", 1000);
