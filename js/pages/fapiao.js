...
var FaPiao = {
    ...
    "Init": function () {
        ...
        if (typeof (sDetailType) != "undefined") {
            ...
            $("#sp_billRemark").html(JSON.parse(sDetailType).billremark.replace(/\n/g, '<br>'));
        }
        $("#fpnrtype").empty();
        var html = "";
    ...
    "Back": function () {
        window.location.replace(g_const_PageURL.OrderConfirm + "?uid=" + FaPiao.uid + "&noclear=1&t=" + Math.random());
    },
    /*保存*/
    "Save": function () {
