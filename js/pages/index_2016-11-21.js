                        ...
                        if(j==0){
                            ...
                            if (other_content.title!= "" && other_content.description != "") {
                                html += "<div class=\"l-goods-txt\">"
                                    + "<p class=\"txt01\">" + FormatText(other_content.title, 5) + "</p>"
                                    + "<p class=\"txt04\"><i class=\"count\">" + FormatText(other_content.description, 9) + "</i></p>"
                                + "</div>";
                            }
                            ...
                            html += "<a " + temp_asdfgghhh1 + "><div class=\"l-goods clearfix\">"
                            if (other_content.title != "" && other_content.description != "") {
                                html += "<div class=\"l-goods-txt\">"
                                    + "<p class=\"txt01\">" + FormatText(other_content.title, 5) + "</p>"
                                    + "<p class=\"txt04\"><i class=\"count\">" + FormatText(other_content.description, 9) + "</i></p>"
