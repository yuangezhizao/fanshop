...
var Address_Info = {
    ...
    GetList: function () {
        ...
        var obj_data = { "api_input": s_api_input, "api_target": Address_Info.api_target };
        var purl = g_INAPIUTL;
        var request = $.ajax({
            url: purl,
            cache: false,
        ...
        if (result.length>0) {
            ...
            $.each(result, function (i, n) {
                if (n.isdefault == "1") {
                    ...
                    body_default += "<p>" + (n.idNumber.substr(0, 4) + (n.idNumber.length>0?"**********":"") + n.idNumber.substr(14)) + "</p>";
                    ...
                    body_lastused += "<p>" + (n.idNumber.substr(0, 4) + (n.idNumber.length > 0 ? "**********" : "") + n.idNumber.substr(14)) + "</p>";
                    ...
                    body_common += "<p>" + (n.idNumber.substr(0, 4) + (n.idNumber.length > 0 ? "**********" : "") + n.idNumber.substr(14)) + "</p>";
                    body_common += "</section>";
