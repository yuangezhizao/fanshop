...
var CouponCodeExchange = {
    ...
    Load_Result: function (type) {
        ...
        if ($("#hidcardid").val()!="") {
            ...
            switch (type) {
                case 1://成功
                    ShowMesaageCallback($("#lbl_succ_1").html(), ResultApp, 3000);
                    break;
                case 2://已兑换
                    ShowMesaageCallback($("#lbl_have_1").html(), ResultApp, 3000);
                    break;
                case 0://失败
                    ShowMesaageCallback($("#lbl_fail_1").html(), ResultApp, 3000);
                    break;
            }
        }
