...
$(document).ready(function () {
    //ShowMesaageCallback("领取成功啦！", "CloseAct", 2000);
    ...
    if (localStorage["actlist"] == null && !(actlist==undefined)) {
...
var CouponCodeExchange = {
    ...
    Load_Result: function (type) {
        ...
        switch (type) {
            case 1://成功
                ShowMesaageCallback($("#lbl_succ_1").html(), CloseAct, 4000);
                break;
            case 2://已兑换
                ShowMesaageCallback($("#lbl_have_1").html(), CloseAct, 4000);
                break;
            case 0://失败
                ShowMesaageCallback($("#lbl_fail_1").html(), CloseAct, 4000);
                break;
        }
    },
    //接口返回失败后的处理
