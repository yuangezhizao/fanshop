...
$(document).ready(function () {
    ...
    if (localStorage["actlist"]!=null) {
        if (localStorage["actlist"] != "") {
            ...
            //$("#lbl_succ_0").html("在触屏版查看<i>超值好货 &gt;&gt;</i>");
            //$("#lbl_succ_1").html("领取成功");
            //$("#lbl_succ_2").html("移动APP下单及时查看订单状态哦！");
            //$("#lbl_succ_3").html("下载APP,使用红包更超值");


            //$("#lbl_have_0").html("在触屏版查看<i>超值好货 &gt;&gt;</i>");
            //$("#lbl_have_1").html("您已领取");
            //$("#lbl_have_2").html("移动APP下单及时查看订单状态哦！");
            //$("#lbl_have_3").html("下载APP,使用红包更超值");
            //$("#lbl_have_4").html("新人还有大礼包哦！");

            //$("#lbl_fail_0").html("在触屏版查看<i>超值好货 &gt;&gt;</i>");
            //$("#lbl_fail_1").html("领取失败");
            //$("#lbl_fail_2").html("移动APP下单及时查看订单状态哦！");
            //$("#lbl_fail_3").html("下载APP,使用红包更超值");
